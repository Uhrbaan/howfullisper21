...
int init_wifi() {
    ...
    err = esp_wifi_set_mode(WIFI_MODE_STA);  // sets the wifi mode to sta (client not hotspot (ap))
    if (err != ESP_OK) {
    ...
    wifi_config_t wifi_config = {
        .sta = {.ssid = {'u', 'h', 'r', 'b', 'a', 'a', 'n', 0},  // has to be written like that because gcc is a b*tch
                .password = {'1', '2', '3', '4', '5', '6', '7', '8', 0},  // same here
